    ...
    $scope.loginEmail = function (formName, cred) {
      ...
      if (formName.$valid) {  // Check if the form data is valid or not
        ...
        firebase.auth().signInWithEmailAndPassword(cred.email, cred.password).then(function (result) {
          ...
          var url = 'http://localhost:8080/MQTT/apiRest/usuario/insertUsuarioGet/?correo=' + correo + '&pass=' + pass + '&idUsuarioFirebase=' + idUsuarioFirebase + '';
    ...
    $scope.itemManipulation = function (edit_val) {  // Takes care of item add and edit ie Item Manipulator
      ...
      connectionPopup.then(function (res) {
        ...
        if (edit_val != null) {
          ...
          var url = 'http://localhost:8080/MQTT/apiRest/topic/insertTopicsGet/?topic=' + topic + '&descripcion=' + descripcion + '&elemento=' + elemento + '&imagen=' + imagen + '&idTopicFirebase=' + idTopicFirebase + '&clientId=' + clientId + '&idUsuarioFirebase=' + idUsuarioFirebase + '';
  ...
  .controller('settingsCtrl', function ($scope, $rootScope, fireBaseData, $firebaseObject,
    ...
    $scope.save = function (mqttRef) {
      ...
      if ((mqttRef.url != "" && mqttRef.url != null) &&
        ...
        var url = 'http://localhost:8080/MQTT/apiRest/conexion/insertConexionGet/?nombreServicio=' + nombreServicio + '&host=' + host + '&puerto=' + puerto + '&ssl=' + ssl + '&usuario=' + usuario + '&password=' + password + '&clientId=' + clientId + '&idUsuarioFirebase=' + idUsuarioFirebase + '';
  ...
  .controller('graphCtrl', function ($scope, $rootScope, fireBaseData,
    ...
    function onMessageArrived(message) {
      ...
      //console.log(idTopicFirebase);
       var url = 'http://localhost:8080/MQTT/apiRest/usuarioConexionTopic/insertUsuarioConexionTopicGet/?valor=' + valor + '&idUsuarioFirebase=' + idUsuarioFirebase + '&clientId=' + clientId + '&idTopicFirebase=' + idTopicFirebase;
